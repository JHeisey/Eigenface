...
k = 60;%Dimensionality reduction, must be greater than 5
pv = [1 8 15 22 29 36 43 50 57 64];%Vector of face index in training set
pv2 = [1 4 7 10 13 16 19 22 25 28];%Vector of face index in testing set
